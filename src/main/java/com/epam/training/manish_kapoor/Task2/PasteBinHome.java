...
public class PasteBinHome {
    ...
    private WebElement syntaxHighlightingMenuButton;

    @FindBy(xpath = "//li[contains(text(), 'Bash')]")
    private WebElement syntaxHighlightBash;
    ...
    public PasteBinHome clickSyntaxHighlightingMenu() {
        syntaxHighlightingMenuButton.click();
        return this;
    }

    public PasteBinHome chooseSyntaxHighlightBash() {
        wait.until(ExpectedConditions.visibilityOf(syntaxHighlightBash)).click();
        return this;
    }
    ...
    public PasteBin clickCreateButton() {
        createNewPasteButton.click();
        return new PasteBin(webDriver);
    }
